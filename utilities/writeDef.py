...
# Author:	Sam Hewitt
# Date  : 	02/08/18
# Usage :       ./writeDef.py -i "filename".dat -o "filename.def"
# Description:	Writes the definitions file program xx20
#======================================================================
...
class definition: 
    def __init__(self,scrit=0.005,load=0.01):
...
if __name__ == "__main__":
    ...
    myDef = definition(scrit=0.005,load=0.1)
